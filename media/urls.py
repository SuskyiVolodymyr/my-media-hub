...
urlpatterns = [
    ...
    path("user_series/", UserSeriesListView.as_view(), name="user-series-list"),
    path("user_series_data/<int:pk>/update/", update_user_series_data_view, name="user-series-data-update"),
